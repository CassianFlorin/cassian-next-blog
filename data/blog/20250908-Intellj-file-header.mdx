...
tags:
  ...
  - Tips
summary: >-
  分享如何在 IntelliJ IDEA 中自定义 File Header，通过 Groovy
  脚本实现动态生成不同项目的文件头信息，提高代码可维护性和团队协作效率。
tldr: >-
  IntelliJ 的文件头模板在 Settings → Editor → File and Code Templates → Includes → File Header 里配置。用 Groovy 脚本判断 ${PACKAGE_NAME} 的包名前缀，就能让个人项目和公司项目自动生成不同的文件头。
---
