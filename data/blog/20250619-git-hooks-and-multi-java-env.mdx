...
tldr: >-
  多 JDK 共存时，Maven Spotless 会因为高版本 JDK 报 InvocationTargetException。解法是用 SDKMAN 装所需版本，项目根目录放 .sdkmanrc，并在 pre-commit hook 开头加载 SDKMAN，锁死构建用的 Java 版本。
draft: false
---
...
参考 [SDKMAN 安装与配置指南](/blog/20250619-install-sdkman) 文档，其中对 Mac 系统环境与 Windows 系统环境的安装都有详细指导。
...
# 2. 如果您没有安装 SDKMAN，请参考 [SDKMAN 安装与配置指南](/blog/20250619-install-sdkman)
...
**解决方案**: 参考 [SDKMAN 安装与配置指南](/blog/20250619-install-sdkman)
...
- [SDKMAN 安装与配置指南](/blog/20250619-install-sdkman) - 详细的 SDKMAN 安装和配置步骤
